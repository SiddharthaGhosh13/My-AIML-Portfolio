...
function PhaseCounter({ target, inView }) {
  ...
  return (
    <span className="font-display text-5xl tabular-nums text-accent-primary lg:text-9xl">
...
export default function Vision() {
  ...
  return (
    <section
      id="vision"
      ref={ref}
      className="grain relative overflow-hidden border-b border-border bg-[radial-gradient(ellipse_at_top,_rgba(0,212,255,0.08),transparent_55%),radial-gradient(ellipse_at_bottom,_rgba(240,165,0,0.07),transparent_50%),#05070a] px-4 py-16 md:px-6 md:py-24 lg:px-8"
    ...
    >
      ...
      <div className="relative z-[2] mx-auto w-full max-w-6xl">
        ...
        >
          ...
          <h2 id="vision-heading" className="mt-4 font-display text-3xl font-semibold tracking-tight text-text-primary md:text-6xl">
            Beyond the Code
          </h2>
          <p className="mt-6 font-body text-base leading-relaxed text-text-secondary md:text-xl">{siteMeta.visionStatement}</p>
        </motion.div>

        <div className="mt-12 flex flex-col gap-6 lg:mt-16 lg:grid lg:grid-cols-3 lg:gap-8">
          {visionPhases.map((phase, idx) => {
            ...
            return (
              <motion.article
                ...
                className="relative overflow-hidden rounded-2xl border border-border bg-bg-card/80 p-5 shadow-card backdrop-blur-md md:p-8"
              >
                ...
                <h3 className="relative mt-6 font-display text-2xl font-semibold text-text-primary md:mt-8 md:text-2xl">
                  {phase.title}
                </h3>
